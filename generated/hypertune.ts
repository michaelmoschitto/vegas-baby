...
export const queryCode = `query FullQuery{root{enableCardScanning}}`;

export const query: sdk.Query<sdk.ObjectValueWithVariables> = {"variableDefinitions":{},"fragmentDefinitions":{},"fieldQuery":{"Query":{"type":"InlineFragment","objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"type":"InlineFragment","objectTypeName":"Root","selection":{"enableCardScanning":{"fieldArguments":{},"fieldQuery":null}}}}}}}}};

export const vercelFlagDefinitions = {"enableCardScanning":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/4781/main/draft/logic?selected_field_path=root%3EenableCardScanning"}};
...
const rootFallback = {enableCardScanning:false};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/4781/main/draft/logic?selected_field_path=root%3EenableCardScanning})
   */
  enableCardScanning({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("enableCardScanning", { fieldArguments: args });
...
const sourceFallback = {root:{enableCardScanning:false}};
